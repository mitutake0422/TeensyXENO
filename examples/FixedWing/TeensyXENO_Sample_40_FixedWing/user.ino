...
void userfunc() {
    ...
    //XenoVehicleFixedWing* fw = g_clTX.GetFixedWing();
	...
	if (g_clTX.m_core.m_nCtrl == MANUAL) {
		...
		//-----------------------------------------------
		// 自動操縦のプログラムをここに記述してください
		//-----------------------------------------------

		//-----------------------------------------------

		g_clTX.m_core.m_stSbusCmd.ushCH1 = 1023;   // THR
		g_clTX.m_core.m_stSbusCmd.ushCH2 = 1023;   // AIL_R
		g_clTX.m_core.m_stSbusCmd.ushCH3 = 1023;   // ELV
		g_clTX.m_core.m_stSbusCmd.ushCH4 = 1023;   // RUD
		g_clTX.m_core.m_stSbusCmd.ushCH5 = 1023;   // AIL_L
